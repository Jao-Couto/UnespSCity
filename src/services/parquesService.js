...
class ParquesService {
    ...
    async getOne(id) {
        return axios({
            url: ServerMYSQL + "/api/parques/getOne/" + id,
            method: "GET",
            timeout: 10000,
            headers: {
                'Content-Type': 'application/json',
    ...
    async addHistory(data) {
        return axios({
            url: ServerMYSQL + "/api/parques/addHistory",
            method: "PUT",
            timeout: 10000,
            data: data,
            headers: {
...
const parquesService = new ParquesService()
export default parquesService