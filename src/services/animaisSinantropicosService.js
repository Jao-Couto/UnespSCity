...
class AnimaisSinantropicosService {
    ...
    async create(data) {
        return axios({
            url: ServerMYSQL + "/api/animais_sinantropicos",
            method: "POST",
            timeout: 10000,
            data: data,
            headers: {
    ...
    async getMarkers() {
        return axios({
            url: ServerMYSQL + "/api/animais_sinantropicos/markers",
            method: "GET",
            timeout: 10000,
            headers: {
                'Content-Type': 'application/json',
    ...
    async updateResolved(data) {
        return axios({
            url: ServerMYSQL + "/api/animais_sinantropicos/update_resolved/" + data,
            method: "PUT",
            timeout: 10000,
            headers: {
                'Content-Type': 'application/json',
